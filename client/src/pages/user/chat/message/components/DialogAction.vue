...
<template>
  <div ref="actionRef" class="dialog-action" :class="{ 'dialog-action--shadow': shadowed }">
...
.dialog-action {
  ...
  font-size: 0.95rem;
  transition:
    box-shadow 0.2s $ease-out-circ,
    border-radius 0.2s $ease-out-circ;
