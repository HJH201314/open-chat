      ...
      >
        <template #operation="{ row }">
          <t-space size="small">
            ...
            <t-link theme="primary" hover="color" @click="handleModel(row)">模型</t-link>
            <t-link theme="primary" hover="color" @click="handleConfigKey(row)">APIKey</t-link>
...
const columns = ref<PrimaryTableCol<ApiSchemaProvider>[]>([
  ...
  { colKey: 'operation', title: '操作', width: '12rem', fixed: 'right' },
]);
